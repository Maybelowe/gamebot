...
export async function rankcard(rank, pp, lv, cExp, nExp, name, discriminator) {
   const imeg = `https://melcanz.com/rank?rank=${rank}&pp=${pp}&level=${lv}&currentxp=${cExp}&needxp=${nExp}&name=${name}&discriminator=${discriminator}&apikey=melcantik`
  return await imeg.buffer()
}
